...
app = FastAPI(
    ...
    description="A single-endpoint API that uses a LangChain agent to handle leave management tasks for both employees and managers.",
    version="4.0.0"
)
...
@app.get("/")
def read_root():
    return {"message": "Agentic Leave Management System."}
